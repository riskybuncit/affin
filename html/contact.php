                    ...
                    <li class="dropdown dropdown-supermenu">
                        ...
                        <ul class="dropdown-menu supermenu accepts-5">
                            <li class="row">
                                ...
                                <div class="span3">
                                    <div class="embed-container"><iframe src="//player.vimeo.com/video/5606758" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
            ...
            <div class="span3">
                <div class="cart-container" id="cartContainer">
                    ...
                    <div class="open-panel">
                            ...
                            <div class="desc">
                                <strong><a href="product.html">Vivamus Sed Dapibus Est</a></strong>
                            ...
                            <div class="desc">
                                <strong><a href="product.html">Lorem Ipsum Tincidunt Vel Est Amet</a></strong>
                                <span class="light-clr qty">
                                    Qty: 1
                                    &nbsp;
                                    <a href="#" class="icon-remove-sign" title="Remove Item"></a>
                            ...
                            <div class="desc">
                                <strong><a href="product.html">Sit Neque Est Feugiat</a></strong>
                                <span class="light-clr qty">
                                    Qty: 1
                                    &nbsp;
                                    <a href="#" class="icon-remove-sign" title="Remove Item"></a>
            ...
            <div class="row">
                ...
                <section class="span8 single single-page">
                    ...
                    <section class="contact-form-container">
                        ...
                        <?php include 'incl/send-email.php'; ?> 
                    </section>
...
Aliquam tincidunt vestibulum risus et gravida.</p>
                        ...
                        <form action="//proteusthemes.us4.list-manage1.com/subscribe/post?u=ea0786485977f5ec8c9283d5c&amp;id=5dad3f35e9" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate form form-inline" target="_blank" novalidate>
